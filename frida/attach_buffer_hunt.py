"""Attach M8P3.7 skin buffer hunt. See JS for protocol.

Usage (admin shell):
    python frida\attach_buffer_hunt.py > frida\buffer_hunt.log
"""
import sys, time
from pathlib import Path
import frida

SCRIPT = Path(__file__).parent / "16_skin_buffer_hunt.js"
